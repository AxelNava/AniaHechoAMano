  ...
  >
    <div
      :class="cn(
        ...
        variant === 'floating' || variant === 'inset'
          ? 'group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+calc(theme(spacing.4)*2))]'
    ...
    <div
      :class="cn(
        ...
        variant === 'floating' || variant === 'inset'
          ? 'p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+calc(theme(spacing.4)*2)+2px)]'
